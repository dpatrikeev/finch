<script lang="ts">
  ...
  import { getStudentById } from '../data.remote';

  import { ArrowLeft, Mail, BookOpen } from 'lucide-svelte';
  import { calculateOverallHomeworkStats } from '../utils';
